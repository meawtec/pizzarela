...
<div id="div2login">
  ...
  <div id="divlogin">
    ...
    <form id="form" method="POST" action="loginPage.php"><br>
      ...
      <br>
      <div id="olho">
      <label></label><input type="password" placeholder="Senha" name="senha" id="senha"> <img src="../imagens/cadiado.png" alt="18rem">
     <!-- 
            <i class="bi bi-eye"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30px" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
